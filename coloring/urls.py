...
urlpatterns = [
  ...
  path('wasteless/<slug:username>/profile/', views.profile),     path('wasteless/<slug:username>/profile/mylistings/', views.mylistings), path('wasteless/<slug:username>/profile/claimed/', views.claimed),
